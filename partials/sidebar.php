    ...
    <aside class="app-sidebar" id="appSidebar">
      <div class="sidebar-inner">
        <nav class="sidebar-nav" aria-label="Main navigation">
          <a href="./dashboard" class="sidebar-nav-item <?= $currentPage === 'dashboard' ? 'sidebar-nav-item--active' : '' ?>" data-tooltip="Dashboard">
          ...
          <a href="./projects" class="sidebar-nav-item <?= $currentPage === 'projects' ? 'sidebar-nav-item--active' : '' ?>" data-tooltip="Projects">
            <svg class="sidebar-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          ...
          <a href="./blog" class="sidebar-nav-item <?= $currentPage === 'blog' ? 'sidebar-nav-item--active' : '' ?>" data-tooltip="Blog Posts">
            <svg class="sidebar-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          ...
          <a href="./awards" class="sidebar-nav-item <?= $currentPage === 'awards' ? 'sidebar-nav-item--active' : '' ?>" data-tooltip="Awards">
            <svg class="sidebar-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          ...
          <a href="./messages" class="sidebar-nav-item <?= $currentPage === 'messages' ? 'sidebar-nav-item--active' : '' ?>" data-tooltip="Messages">
            <svg class="sidebar-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          ...
          <a href="./analytics" class="sidebar-nav-item <?= $currentPage === 'analytics' ? 'sidebar-nav-item--active' : '' ?>" data-tooltip="Analytics">
            <svg class="sidebar-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
